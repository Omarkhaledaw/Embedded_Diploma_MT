...
void systick_init(){
  ...
  SYSTICK_RELOAD_REG = 9999999; //Set the RELOAD value in the reload register
...
void pll_init(){
  ...
  SYSCTL_RCC2_REG = ((SYSCTL_RCC2_REG & ~0x1FC00000)|(49<<22));//Clear the SYSDIV2 before adding the divider value to it
